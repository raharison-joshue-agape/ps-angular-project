#!/usr/bin/env zsh
# primeng.zsh — Crée un projet Angular + PrimeNG + TypeScript pré-configuré.
...
new_angular_primeng() {
    ...
    echo "Creating project: $PROJECT_NAME (Angular + PrimeNG + SCSS + Routing)"
    ...
    npm install primeng @primeuix/themes primeicons "@angular/animations@$NG_VERSION"
    if [ $? -ne 0 ]; then
        echo "Erreur lors de l'installation de PrimeNG." >&2
        return 1
    fi
